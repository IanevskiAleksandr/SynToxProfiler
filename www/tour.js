...
$( document ).ready(function() {
    ...
    tour.addSteps([
      ...
      element: "#getstarted",
      title: "Welcome!", 
      content: "Welcome to SynToxProfiler exploration tour. <br>It will introduce you to our application by walking through it step by step.",
	  placement: "right",
	  duration: 8000,
	  backdrop: true
	  },
 ...
 document.getElementById("tour_").addEventListener("click",function(){0==tourused?tour.start():tour.restart(),tourused++},!1);
